...
public class MixinPlugin implements IMixinConfigPlugin {
    ...
    private static final Map<String, Supplier<Boolean>> APPLY_IF_PRESENT = ImmutableMap.of(
            "com.github.razorplay01.ismah.mixin.LivingEntityRendererMixin", () -> FabricLoader.getInstance().isModLoaded("playeranimator"),
            "com.github.razorplay01.ismah.mixin.HumanoidArmorLayerMixin", () -> FabricLoader.getInstance().isModLoaded("playeranimator")
    );
