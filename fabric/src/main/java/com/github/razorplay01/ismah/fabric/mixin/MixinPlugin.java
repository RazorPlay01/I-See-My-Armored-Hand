...
public class MixinPlugin implements IMixinConfigPlugin {
    ...
    private static final Map<String, Supplier<Boolean>> APPLY_IF_PRESENT = ImmutableMap.of(
            "com.github.razorplay01.ismah.fabric.mixin.LivingEntityRendererMixin", () -> FabricLoader.getInstance().isModLoaded("player-animator"),
            "com.github.razorplay01.ismah.fabric.mixin.HumanoidArmorLayerMixin", () -> FabricLoader.getInstance().isModLoaded("player-animator")
    );

    private static final Map<String, Supplier<Boolean>> APPLY_IF_ABSENT = ImmutableMap.of(
            "dev.kosmx.playerAnim.mixin.firstPerson.LivingEntityRendererMixin", () -> !FabricLoader.getInstance().isModLoaded("player-animator")
    );
