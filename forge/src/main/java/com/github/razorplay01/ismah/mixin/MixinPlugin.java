...
public class MixinPlugin implements IMixinConfigPlugin {
    ...
    private static final Map<String, Supplier<Boolean>> APPLY_IF_PRESENT = ImmutableMap.of(
            //"com.github.razorplay01.ismah.mixin.LivingEntityRendererMixin", () -> ModList.get().isLoaded("player-animator"),
            //"com.github.razorplay01.ismah.mixin.HumanoidArmorLayerMixin", () -> ModList.get().isLoaded("player-animator")
    );
