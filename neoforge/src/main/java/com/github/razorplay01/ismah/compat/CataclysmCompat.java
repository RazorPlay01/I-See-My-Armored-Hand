...
public class CataclysmCompat implements CustomArmorRenderer {
    ...
    public void render(PoseStack poseStack, MultiBufferSource vertexConsumers, int light, ItemStack stack, HumanoidArm arm, HumanoidModel<@NotNull LivingEntity> playerModel) {
        if (stack.getItem() instanceof Bone_Reptile_Armor) {
            renderCataclysmArmor(poseStack, vertexConsumers, light, stack, arm, playerModel,
                    new Bone_Reptile_Armor_Model(Minecraft.getInstance().getEntityModels().bakeLayer(CMModelLayers.BONE_REPTILE_ARMOR_MODEL)),
                    ResourceLocation.fromNamespaceAndPath("cataclysm", "textures/models/armor/bone_reptile_armor.png"));
    ...
    private static void renderCataclysmArmor(PoseStack poseStack, MultiBufferSource vertexConsumers, int light, ItemStack stack, HumanoidArm arm, HumanoidModel<@NotNull LivingEntity> playerModel, HumanoidModel<@NotNull LivingEntity> armorModel, ResourceLocation texture) {
